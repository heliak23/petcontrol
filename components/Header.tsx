...
const Header = () => {
    ...
    const { signOut, user } = useAuth(); // Using AuthContext
    ...
    const handleProfileClick = () => {
        ...
        console.log('Attempting to navigate to /perfil...');
        navigate('/perfil');
                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            className="relative group cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
